...
public class GerarArquivoCacert {  
    private static final String JSSECACERTS = "c:/homologacaoNFE.jks";	//Homologacao
    //private static final String JSSECACERTS = "c:/producaoNFE.jks";			//Producao
    private static final int TIMEOUT_WS = 30;  
  
    public static void main(String[] args) {  
        try {  
            char[] passphrase = "unimed01".toCharArray();  
            ...
            get("homologacao.nfe.fazenda.sp.gov.br", 443, ks);  // homologacao NFE
            //get("nfe.fazenda.sp.gov.br", 443, ks); //producao NFE  
